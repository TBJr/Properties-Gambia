                ...
                <div class="card-tools">
                    <ul class="nav nav-pills ml-auto">
                        <li class="nav-item mr-1">
                            <button class="btn btn-sm btn-primary" @click="get()"><i class="fas fa-user"></i> All Clients </button>
                        </li>
                    ...
                    <form>
                        <div class="modal-body">
                            <div class="form-group">
                                ...
                                <input v-model="form.fname" type="text" name="fname" placeholder="First Name"
                                    class="form-control" :class="{'is-invaild': form.errors.has('fname')}">
                                <has-error :form="form" field="fname"></has-error>
                            </div>

                            <div class="form-group">
                                <label> Middle Name </label>
                                <input v-model="form.mname" type="text" name="mname" placeholder="Middle Name"
                                    class="form-control" :class="{'is-invaild': form.errors.has('mname')}">
                                <has-error :form="form" field="mname"></has-error>
                            </div>

                            <div class="form-group">
                                <label> Last Name </label>
                                <input v-model="form.name" type="text" name="lname" placeholder="Last Name"
                                    class="form-control" :class="{'is-invaild': form.errors.has('lname')}">
