                                                ...
                                                <div class="w-100">
                                                    <div class="d-flex flex-column h-100">
                                                        ...
                                                        <div class="mt-4 text-center">
                                                            <p class="mb-0">© <script>document.write(new Date().getFullYear())</script> {{ config('app.client_company_name') }}. Crafted with <i class="mdi mdi-heart text-danger"></i> by {{ config('app.developer_username') }}</p>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
