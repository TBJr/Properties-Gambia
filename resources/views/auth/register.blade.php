                                    ...
                                    <form class="needs-validation" novalidate method="POST"
                                        ...
                                        <div class="mb-3">
                                            <p class="mb-0 fs-12 text-muted fst-italic">By registering you agree to the
                                                {{ config('app.client_company_name') }} <a href="#"
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="text-center">
                            ...
                            </script> {{ config('app.client_company_name') }}. Crafted with <i class="mdi mdi-heart text-danger"></i> by {{ config('app.developer_username') }}</p>
                        </div>
                    </div>
                </div>
            </div>
