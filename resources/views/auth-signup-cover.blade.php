                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="text-center">
                                <p class="mb-0">&copy; <script>document.write(new Date().getFullYear())</script> {{ config('app.client_company_name') }}. Crafted with <i class="mdi mdi-heart text-danger"></i> by {{ config('app.developer_username') }}</p>
                            </div>
                        </div>
                    </div>
                </div>
