...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body>
        ...
        <footer>
            ...
            <small>
                Copyright &copy; 2021 All rights reserved | Made with <span class="fa fa-heart"></span> by <a href="{{ config('app.developer_company_website') }}">{{ config('app.developer_username') }}</a>
            </small>
        </footer>
