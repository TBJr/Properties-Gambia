...
<body>
    ...
    {{-- <section id="properties">
        <div class="container">
            ...
            <div id="properties-slider" class="slick">
                <div>
                    <img src="{{ asset('images/land01.jpeg') }}" alt="Property 1" />
                    <div class="property-details">
                        <p class="price">GMD 150,000</p>
                        <span class="plot_name">Plot Name</span>
                        <span class="plot_number">Plot No. 5</span>
                        <span class="sqft"> 300 m2.</span>
                        <address>
                            Sayang Sea View, Banjul - The Gambia
                        </address>
                    </div>
                </div>
                ...
                <div>
                    ...
                    <div class="property-details">
                        <p class="price">GMD 250,000</p>
                        <span class="plot_name">Plot Name</span>
                        <span class="plot_number">Plot No. 6</span>
                        <span class="sqft">1569 m2</span>
                        <address>
                            Gunjur, Banjul - The Gambia
                        </address>
                    </div>
                </div>
            ...
            <div class="flex">
                <div id="form-container">
                    ...
                    <form>
                        ...
                        <input type="text" id="email" placeholder="yourmail@email.com"/>

                        <label for="subject">Subject</label>
                        <input type="text" id="subject" placeholder="e.g: Need More Information" />

                        {{-- <label for="message">Message</label>
                        <textarea id="message">Write your message here..</textarea> --}}
                        <label for="message">Message</label>
                        <textarea id="message" placeholder="Write you message here..."></textarea>
    ...
    <footer>
        ...
        <small>
            Copyright &copy; 2020 - 2021 All rights reserved | Made with <span class="fa fa-heart"></span> by <a href="#">TBJ</a>
        </small>
    </footer>
