    ...
    <body>
                ...
                <div id="properties-slider" class="slick">
                    ...
                    <div>
                        ...
                        <div class="property-details">
                            <a>GMD {{$land->plot_price}}</a> <br>
                            <a href="{{ route('plot.view', [$land->id]) }}" title="View">{{$land->plot_address}}</a> <br>
                            <a class="beds">Size: {{$land->plot_size}}</a>
        ...
        <section id="agents">
            <div class="container">
                ...
                <div class="flex">
                    <div class="card">
                        <img src="{{ asset('images/daniel-new1.jpeg') }}" alt="Daniel Samba" />
                        <h3>Daniel Samba</h3>
                        <p>C.E.O</p>
                    </div>
