...
<body>
        ...
        <header>
            <div class="flex container">
                ...
                <a href="#" class="navbar-brand">
                    <img src="{{ asset('images/logoo.ico') }}" width="50" alt="PGRE" class="d-inline-block align-middle mr-2">
                </a>
                <!-- Logo Text -->
    ...
    <footer>
        ...
        <small>
            Copyright &copy; 2021 All rights reserved | Made with <span class="fa fa-heart"></span> by <a href="#">TBJ</a>
        </small>
    </footer>
